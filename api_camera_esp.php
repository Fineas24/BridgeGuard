...
$SAVE_DIR     = "$BASE_DIR/uploads/poze_sub_pod";
$VENV_PYTHON  = "$BASE_DIR/Python/detect_poze/bin/python3";
$ESP_CAPTURE  = 'http://192.168.100.55/capture';
...
switch ($action) {
    ...
    case 'detect':
        ...
        $cap_filename = "esp_{$timestamp}.jpg";
        $det_filename = "esp_{$timestamp}_fisuri.jpg";
...
PYEOF;
        ...
        echo json_encode(array_merge([
            'success'       => true,
            'capture'       => "uploads/poze_sub_pod/$cap_filename",
            'detection'     => "uploads/poze_sub_pod/$det_filename",
